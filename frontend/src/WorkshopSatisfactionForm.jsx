...
const WorkshopSatisfactionForm = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (selectedWorkshops.length > 0 && satisfaction !== null && educationLevel && age && occupation) {
      const selected = satisfactionOptions.find(r => r.value === satisfaction);
      setLoading(true);
      try {
        const formData = new FormData();
        formData.append('selected_workshops', selectedWorkshops.join('; '));
        ...
        const response = await fetch(
          'https://script.google.com/macros/s/AKfycbwr5bCJHuYiObmMDuiqrcS5p-auhSFc-AtFuaz3cvQy5_Vs-M_kW_NJh8vwr7OEwBxZ/exec',
          {
            method: 'POST',
            body: formData,
            mode: 'no-cors'
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-base font-semibold text-orange-800 mb-6 text-center">
            แบบประเมินความพึงพอใจในการเข้าร่วมงาน สำหรับการร่วมกิจกรรม Workshop ภายในงาน
          </p>
            ...
            {!submitted ? (
              ...
              >
                ...
                <motion.button
                  ...
                  disabled={selectedWorkshops.length === 0 || satisfaction === null || !educationLevel || !age || !occupation || loading}
                >
...
export default WorkshopSatisfactionForm; 