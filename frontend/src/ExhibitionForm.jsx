...
const benefitOptions = [
  'องค์ความรู้เรื่องยางรัก และกระบวนการสร้างสรรค์เครื่องรักของไทยและนานาชาติ',
  'สุนทรียจากการชมผลงานการสร้างสรรค์ภายในนิทรรศการ',
  'แรงบันดาลใจ และการประยุกต์สู่การใช้จริงทั้งการสร้างสรรค์ และการศึกษาต่อยอด',
  'การพบผู้ชื่นชอบงานศิลปหัตถกรรม และเครือข่ายผู้ชื่นชอบงานศิลปหัตถกรรม',
];
...
const ExhibitionForm = ({ onBack }) => {
    ...
    if (educationLevel && age && occupation && satisfaction !== null) {
      ...
      try {
        ...
        const response = await fetch(
          'https://script.google.com/macros/s/AKfycbyciNIfjcAGgIua8giDaYVlbewCSQX4FRpxO4n90JX4C9EIwOZf1ENl9xv2GbSTO67rkA/exec',
          {
            method: 'POST',
            body: formData,
            mode: 'no-cors'
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-300 p-4 font-prompt"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
        ...
        >
          ...
          <div className="flex justify-center mb-6 relative">
            {onBack && (
              <button
                onClick={onBack}
                className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors"
              >
                ← กลับ
              </button>
            )}
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-orange-800 mb-2 text-center">
            SACIT Symposium 2025
          </h1>
          <h2 className="text-lg sm:text-xl font-semibold text-orange-700 mb-1 text-center">
          ...
          <p className="text-base font-semibold text-orange-800 mb-6 text-center">
            สำหรับการเยี่ยมชมนิทรรศการหลัก
          </p>
              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">
                    1. โดยรวมแล้ว ท่านรู้สึกพึงพอใจกับประสบการณ์ที่ได้รับจากการชมนิทรรศการ "Lacquer Legacy"
                    (นิทรรศการหลัก) ภายในงาน SACIT Symposium 2025 ในระดับใด?
                  </h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">
                    2. สิ่งที่ท่านได้รับจากชมนิทรรศการ "Lacquer Legacy" (นิทรรศการหลัก) ในครั้งนี้?
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <input
                        ...
                        placeholder="ระบุ..."
                        className="flex-1 px-3 py-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">
                    3. ท่านมีข้อเสนอแนะเพิ่มเติม เพื่อพัฒนาการจัดงานนิทรรศการ SACIT Symposium 2025
                    ในครั้งต่อไปหรือไม่?
                  ...
                  <textarea
                    ...
                    className="w-full h-32 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-lg text-base font-semibold transition disabled:opacity-50"
