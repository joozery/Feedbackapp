...
const benefitOptions = [
  'องค์ความรู้หรือมุมมองใหม่ ๆ ที่ได้รับจากงานวิจัย/ การนำเสนอบทความวิชาการ',
...
const SubRoomForm = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (educationLevel && age && occupation && satisfaction !== null) {
      ...
      try {
        ...
        formData.append('type', 'subroom');

        const response = await fetch(
          'https://script.google.com/macros/s/AKfycbwAXGUIbLgLEE3xeIW_YrLcrHELWwh2xluMH8bxOjFLwk6qjBobnHgqfgHbtg-JHbTUCQ/exec',
          {
            method: 'POST',
            body: formData,
            mode: 'no-cors'
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-green-100 to-green-300 p-4 font-prompt"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
        ...
        >
          ...
          <div className="flex justify-center mb-6 relative">
            {onBack && (
              <button
                onClick={onBack}
                className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors"
              >
                ← กลับ
              </button>
            )}
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-green-800 mb-2 text-center">
            SACIT Symposium 2025
          </h1>
          <h2 className="text-lg sm:text-xl font-semibold text-green-700 mb-1 text-center">
          ...
          <p className="text-base font-semibold text-green-800 mb-6 text-center">
            สำหรับกิจกรรมภายในห้องประชุมย่อย
          </p>
              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">
                    1. โดยรวมแล้ว ท่านรู้สึกพึงพอใจกับประสบการณ์ที่ได้รับจากกิจกรรม ภายใน "ห้องประชุมย่อย" 
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800">
                    2. สิ่งที่ท่านได้รับจากกิจกรรมภายในห้องประชุมย่อย SACIT Symposium 2025 ในครั้งนี้?
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg text-base font-semibold transition disabled:opacity-50"
